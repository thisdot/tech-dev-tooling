...
- [Postico](https://eggerapps.at/postico/)
  Postico is an intuitive app for looking at data. Filter rows, sort them, rearrange columns. You can examine long text or images conveniently in the sidebar.

- [TablePlus](https://tableplus.com/)
  With native build, simple design and powerful features, TablePlus makes database management easier, faster & more efficient for you.
